    ...
    raw = json.dumps(
        {
            ...
            "optional_removed_imports": issue.optional_removed_imports,
            "auxiliary_edits": [edit.model_dump() for edit in issue.auxiliary_edits],
        },
        ensure_ascii=False,
        sort_keys=True,
    )
...
def suggestion_to_result_item(issue: Issue) -> dict[str, Any]:
    ...
    return {
        ...
        "optional_removed_imports": list(issue.optional_removed_imports or []),
        "auxiliary_edits": [edit.model_dump() for edit in issue.auxiliary_edits or []],
        "validation_status": issue.validation_status or "",
        "validation_notes": list(issue.validation_notes or []),
